...
public class AppSettings
{
    ...
    /// <summary>
    /// Opacidade do tom sobre o efeito da barra do Windows. Zero é um valor legítimo: é a barra
    /// limpa, sem tom, que é o efeito que programas como o TranslucentTB entregam.
    /// </summary>
    ...
    public void Sanitize()
    {
        ...
        // O piso é 72, e ele vem do rótulo: "Semanal" no tamanho compacto é o elemento mais largo
        // que sobra depois de apertar fontes, vãos e bolinhas. Coluna sem nome não diz de que
        // limite ela fala, então é aí que a barra para de encolher.
